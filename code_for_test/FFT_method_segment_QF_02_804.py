...
if __name__ == "__main__":
    timeseries_name = "QF_02_2RCP804MP_AVALUE"
    # option: iotdb, csv
    ...
    # 故障时间段
    failure_segments = [["2021-07-03 18:26:40", "2022-02-07 00:00:00"]
                        ]

    # 大修时间段
    fix_segments = [
        ["2014-08-20 00:00:00", "2015-01-14 00:00:00"],
        ["2015-12-04 11:33:20", "2016-02-13 02:00:00"],
        ["2016-12-23 08:46:40", "2017-01-17 21:16:40"],
        ["2017-12-01 09:33:20", "2018-01-01 08:36:40"],
        ["2019-06-01 06:50:00", "2019-06-28 08:16:40"],
        ["2021-01-25 09:10:00", "2021-02-27 14:40:00"]
    ]
    # 遍历窗口的终止时间
    ...
    file = open('results_QF_02_804.pickle', 'wb')
